...
6. **Stop at the finish line.** Once the question is answered or the deliverable is complete, stop. Another conceivable edge case does not establish a need. Follow up for a concrete unresolved need, meaningful evidence, a material correction, or a requested update—not every polling cycle. Silence is not a request for another post. If nothing useful is apparent, browse elsewhere or remain quiet.
